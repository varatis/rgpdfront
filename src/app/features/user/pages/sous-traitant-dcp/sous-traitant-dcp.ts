...
export class SousTraitantDcp implements OnInit {
  ngOnInit() {}
  ...
  sousTraitants: SousTraitant[] = [
    {
      id: 'ST001',
      nom: 'Abstergo Inc',
      prestationFournie: 'Sous-traitant informatique',
      adresseMail: 'john.doe@mail.fr',
      telephone: '02 12 34 56 78',
      contact: 'John Doe',
      roleContact: 'Directeur technique',
      traitementEffectue: 'Hébergement de données',
      donneesTraitees: 'Données personnelles des usagers',
      contratAssocie: 'Contrat #2023-001',
      reference: 'REF-ST-001',
      commentaire: 'Prestataire principal pour l\'hébergement',
      coordonnees: '-'
    },
    {
      id: 'ST002',
      nom: 'Abstergo Ltd',
      prestationFournie: 'Sous-traitant informatique',
      adresseMail: 'guy.hawkins@mail.fr',
      telephone: '02 12 34 56 78',
      contact: 'Guy Hawkins',
      roleContact: 'Directeur informatique',
      traitementEffectue: 'Gestion du SI / Logs',
      donneesTraitees: '-',
      contratAssocie: '-',
      reference: '-',
      commentaire: '-',
    ...
    },
    {
      ...
      nom: 'Big Kahuna',
      prestationFournie: 'Sous-traitant informatique',
      adresseMail: 'kristin.watson@mail.fr',
      telephone: '02 12 34 56 78',
      contact: 'Kristin Watson',
      roleContact: 'Chef de projet',
      traitementEffectue: 'Maintenance applicative',
      donneesTraitees: 'Logs système',
      contratAssocie: 'Contrat #2023-002',
      reference: 'REF-ST-003',
      commentaire: 'Maintenance mensuelle',
      coordonnees: '-'
    },
    {
      id: 'ST004',
      nom: 'Biffco Enterprises',
      prestationFournie: 'Sous-traitant informatique',
      adresseMail: 'ralph.edwards@mail.fr',
      telephone: '02 12 34 56 78',
      contact: 'Ralph Edwards',
      roleContact: 'Responsable infrastructure',
      traitementEffectue: 'Infrastructure cloud',
      donneesTraitees: 'Données de production',
      contratAssocie: 'Contrat #2023-003',
      reference: 'REF-ST-004',
      commentaire: 'Prestataire cloud principal',
      coordonnees: '-'
    },
    {
      id: 'ST005',
      nom: 'Barone',
      prestationFournie: 'Sous-traitant informatique',
      adresseMail: 'albert.flores@mail.fr',
      telephone: '02 12 34 56 78',
      contact: 'Albert Flores',
      roleContact: 'Consultant sécurité',
      traitementEffectue: 'Audit de sécurité',
      donneesTraitees: 'Données de test',
      contratAssocie: 'Contrat #2023-004',
      reference: 'REF-ST-005',
      commentaire: 'Audit annuel',
      coordonnees: '-'
    },
    {
      id: 'ST006',
      nom: 'Little Kahuna',
      prestationFournie: 'Sous-traitant informatique',
      adresseMail: 'robert.fox@mail.fr',
      telephone: '02 12 34 56 78',
      contact: 'Robert Fox',
      roleContact: 'Développeur senior',
      traitementEffectue: 'Développement sur mesure',
      donneesTraitees: 'Données métier',
      contratAssocie: 'Contrat #2023-005',
      reference: 'REF-ST-006',
      commentaire: 'Développement module RH',
      coordonnees: '-'
    },
    {
      id: 'ST007',
      nom: 'Acme Co',
      prestationFournie: 'Sous-traitant informatique',
      adresseMail: 'cody.fisher@mail.fr',
      telephone: '02 12 34 56 78',
      contact: 'Cody Fisher',
      roleContact: 'Chef de projet',
      traitementEffectue: 'Intégration SI',
      donneesTraitees: 'Flux de données',
      contratAssocie: 'Contrat #2023-006',
      reference: 'REF-ST-007',
      commentaire: 'Intégration ERP',
      coordonnees: '-'
    },
    {
      id: 'ST008',
      nom: 'Abstergo',
      prestationFournie: 'Sous-traitant informatique',
      adresseMail: 'jane.cooper@mail.fr',
      telephone: '02 12 34 56 78',
      contact: 'Jane Cooper',
      roleContact: 'Responsable qualité',
      traitementEffectue: 'Tests et recette',
      donneesTraitees: 'Données de test',
      contratAssocie: 'Contrat #2023-007',
      reference: 'REF-ST-008',
      commentaire: 'Tests fonctionnels',
      coordonnees: '-'
    }
  ];
  ...
  onSelectSousTraitant(item: any): void {
    ...
    console.log('Sous-traitant sélectionné:', this.selectedSousTraitant);
  }
  ...
  onExportGlobal(): void {
    console.log('Export global des sous-traitants');
  }

  onFilterSousTraitants(): void {
    console.log('Filtrer les sous-traitants');
  }
