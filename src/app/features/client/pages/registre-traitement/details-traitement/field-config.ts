...
export const TAB_IDENTIFICATION: TabConfig = {
  ...
  fields: [
    ...
    html('Données concernées', 'categoriesPersonnesConcernees', 'donnees_concernees', '40%'),
    ...
    html('Gestionnaire de la mise en œuvre du traitement', 'gestionnaire', 'gestionnaire', '40%'),
...
export const TAB_DESCRIPTION: TabConfig = {
  ...
  fields: [
    ...
    html('Dispositions existantes pour assurer la sécurité des données (physique)',
         'dispositionsSecuriteDonnees', 'dispositions_securite_physique', '90%', 'default', 2),
    ...
    html('Dispositions existantes pour assurer la sécurité des données (numérique)',
         'dispositionsSecuriteDonnees', 'dispositions_securite_numerique', '90%', 'default', 2),
